...
- View and edit policy penalty severity in the Policies dashboard and policy form ([#1248](https://github.com/roostorg/coop/pull/1248) by [@jess-upscrolled](https://github.com/jess-upscrolled))
