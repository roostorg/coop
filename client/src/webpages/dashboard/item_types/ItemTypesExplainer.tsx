          ...
          <tr>
            ...
            <td>
              <div className="my-2 ml-4">
                <b>User</b>: An account or profile on your platform. You may
                just have one user type, but you may have more. For example, a
          ...
          <tr>
            ...
            <td>
              <div className="my-2 ml-4">
                ...
                Facebook Group would be a thread of Posts, where post is a
                Content Type.
              </div>
            </td>
          </tr>
