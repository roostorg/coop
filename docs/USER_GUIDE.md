...
You may want to restrict which Actions can be triggered from a particular Queue. When you create or edit a Queue, you can configure which Actions are hidden for the Queue through its "Hidden Actions" setting.
