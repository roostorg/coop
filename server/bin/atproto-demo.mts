...
function connect() {
  ...
  if (userTypeId) {
    ...
    console.log(
      `  Report submission: enabled (${reportRateLimit}/min, posts + users combined)`,
    );
  } else {
    console.log(`  User submission: disabled (pass --user-type-id to enable)`);
    console.log(
