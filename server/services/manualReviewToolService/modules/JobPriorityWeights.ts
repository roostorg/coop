...
// Persistence for the per-org WEIGHTED sort-mode weights. Validation
// (finite, non-negative, no duplicate properties) happens at the service
// boundary in ManualReviewToolService.setJobPriorityWeights.
